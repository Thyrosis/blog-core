...
<form method="POST" action="{{ route('admin.post.update', $post) }}" >
    ...
    <div class="admin-container">
        ...
        <div class="mb-5">
            ...
            <input class="form-control" id="keywords" name="keywords" placeholder="@lang('keyword, another, one')" type="text" value="{{ old('keywords', $post->getKeywords('string')) }}"></textarea>
        ...
        <div class="mb-5">
            ...
            <input class="form-control" id="metadescription" name="metadescription" placeholder="@lang('A description to put in the meta-tags of the HTML markup.')" type="text" value="{{ old('metadescription', $post->metadescription) }}"></textarea>
