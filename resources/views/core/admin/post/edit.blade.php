...
<form method="POST" action="{{ route('admin.post.update', $post) }}" >
    ...
    <div class="admin-container">
        ...
        <div class="mb-5">
            ...
            <textarea id="summary" name="summary" class="shadow w-full border rounded px-2 py-2 focus:shadow-inner" rows="5">{{ old('summary', $post->summary) }}</textarea>
        ...
        <div class="mb-5">
            ...
            <textarea id="body" name="body" class="shadow w-full border rounded px-2 py-2 focus:shadow-inner tinymce" >{{ old('body', $post->body) }}</textarea>
    ...
    <div class="admin-container">
        ...
        <div class="mb-5">
            ...
            <input type="date" id="published_at" name="published_at" class="shadow w-full border rounded px-2 py-2 focus:shadow-inner" value="{{ old('published_at', $post->published_at->toDateString()) }}" />
