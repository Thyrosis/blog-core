    ...
    <form method="POST" action="{{ route('admin.tag.update', $tag) }}">
        ...
        <div class="">
            <div class="mb-5">
                ...
                <input type="text" id="name" name="name" class="shadow w-full border rounded px-2 py-2 focus:shadow-inner" required value="{{ old('name', $tag->name) }}" />
            ...
            <div class="mb-5">
                ...
                <textarea id="description" name="description" class="shadow w-full border rounded px-2 py-2 focus:shadow-inner tinymce-slim" >{{ old('description', $tag->description) }}</textarea>
